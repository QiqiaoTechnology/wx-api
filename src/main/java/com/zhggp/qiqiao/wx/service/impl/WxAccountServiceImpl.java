...
import com.zhggp.qiqiao.wx.db.dao.WxAccountMapper;
import com.zhggp.qiqiao.wx.db.dto.WxMpInfo;
import com.zhggp.qiqiao.wx.db.entity.WxAccount;
import com.zhggp.qiqiao.wx.service.WxAccountService;
...
public class WxAccountServiceImpl extends ServiceImpl<WxAccountMapper, WxAccount> implements WxAccountService {
    ...
    public void loadWxMpConfigStorages() {
        ...
        wxMpInfo.setAppId(accountList.get(0).getAppid());
        logger.info("微信公众号默认消息 wxMpInfo={}", JSON.toJSONString(wxMpInfo));
